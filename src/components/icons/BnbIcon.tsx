...
export function BnbIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2496 2496" {...props}>
      <g>
        <path fillRule="evenodd" clipRule="evenodd" fill="#F0B90B" d="M1248,0c689.3,0,1248,558.7,1248,1248s-558.7,1248-1248,1248
